  ...
  return (
    <div className="container">
      <div className="d-flex justify-content-between align-items-center mb-2">
        <h4>Schools</h4>
        <div>
          <button className="btn btn-success me-2" onClick={()=>navigate('/Schools/new')}>+ Add School</button>
        </div>
      </div>
      <div style={{ height: 500 }}>
        <DataGrid rows={Schools} columns={columns} pageSize={10} rowsPerPageOptions={[10]} />
      </div>
    </div>
  )
}